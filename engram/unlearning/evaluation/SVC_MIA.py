...
def SVC_MIA(shadow_train, target_train, target_test, shadow_test, model):
    shadow_train_prob, shadow_train_labels = collect_prob(
        shadow_train, model
    )  # shadow_train_prob: (10000,10) 10000 samples, 10 classes
    ...
    )  # (10000,1) model's predicted probability of the ground-truth label
    ...
    shadow_train_entr = entropy(
        shadow_train_prob
    )  # (10000,1) entropy of the model's predicted probability distribution
